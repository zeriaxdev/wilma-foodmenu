...
export function getMenuList(req: Request, res: Response) {
  const providers: MenuProvider[] = [
    ...
    // Food Service Systems
    {
      ...
      supported_features: ["Multiple locations", "Restaurant listings", "Cafeteria menus"]
    },
    {
      id: "jamix",
      name: "Jamix",
      ...
      supported_features: ["Date filtering", "Multiple restaurants", "Advanced search", "Finnish/English"]
    },
    {
      id: "aromi",
      name: "Aromi SaaS",
      ...
      location: "Finland (multiple locations)",
      supported_features: ["Multiple restaurants", "Service-specific endpoints"]
    }
  ];
